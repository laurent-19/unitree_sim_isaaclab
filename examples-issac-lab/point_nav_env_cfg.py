...
class G1ReachPoseSceneCfg(InteractiveSceneCfg):
    ...
    robot: ArticulationCfg = G1_INSPIRE_FTP_CFG.replace(
        ...
        spawn=G1_INSPIRE_FTP_CFG.spawn.replace(activate_contact_sensors=True),
    )
    ...
    # -------------------------
    # LEFT finger/Table contact sensors
    # -------------------------

    # IMPORTANT:
    # This must be the *immediate parent prim* that directly contains the finger link prims.
    # Common candidates are something like:
    #   "{ENV_REGEX_NS}/Robot/left_wrist_pitch_link"
    #   "{ENV_REGEX_NS}/Robot/left_wrist_yaw_link"
    #   "{ENV_REGEX_NS}/Robot/left_hand_link"
    """ INSPIRE_HAND_PARENT = "{ENV_REGEX_NS}/Robot/left_wrist_yaw_link"

    l_index_proximal_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_index_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
    ...
    l_middle_proximal_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_middle_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_pinky_proximal_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_pinky_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_ring_proximal_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_ring_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_thumb_proximal_yaw_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_thumb_proximal_yaw_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_index_intermediate_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_index_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_middle_intermediate_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_middle_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_pinky_intermediate_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_pinky_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_ring_intermediate_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_ring_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_thumb_proximal_pitch_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_thumb_proximal_pitch_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_thumb_intermediate_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_thumb_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    l_thumb_distal_table_contact = ContactSensorCfg(
        prim_path=f"{INSPIRE_HAND_PARENT}/L_thumb_distal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/Table/.*"],
    ...
    # -------------------------
    # LEFT finger/Cylinder contact sensors
    # -------------------------

    """ l_index_proximal_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_index_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
    ...
    l_middle_proximal_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_middle_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_pinky_proximal_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_pinky_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_ring_proximal_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_ring_proximal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_thumb_proximal_yaw_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_thumb_proximal_yaw_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_index_intermediate_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_index_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_middle_intermediate_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_middle_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_pinky_intermediate_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_pinky_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_ring_intermediate_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_ring_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_thumb_proximal_pitch_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_thumb_proximal_pitch_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_thumb_intermediate_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_thumb_intermediate_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
    ...
    l_thumb_distal_cyl_contact = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/L_thumb_distal_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        filter_prim_paths_expr=["{ENV_REGEX_NS}/GraspCylinder/.*"],
...
class EventsCfg:
    ...
    hold_hand_open_then_close = EventTerm(
        ...
        params={
            ...
            "open_pos": {
                ...
                "L_thumb_proximal_yaw_joint": 45.0,
                "L_thumb_proximal_pitch_joint": 10.0,
                "L_thumb_intermediate_joint": 0.0,
                "L_thumb_distal_joint": 0.0,
            },

            # Cylinder grasp starter (degrees)
            "close_pos": {
                # Fingers: proximal curl + intermediate curl
                "L_index_proximal_joint": 85.0,
                "L_index_intermediate_joint": 95.0,

                "L_middle_proximal_joint": 85.0,
                "L_middle_intermediate_joint": 95.0,

                "L_ring_proximal_joint": 85.0,
                "L_ring_intermediate_joint": 95.0,

                "L_pinky_proximal_joint": 85.0,
                "L_pinky_intermediate_joint": 95.0,

                # Thumb: oppose + curl
                "L_thumb_proximal_yaw_joint": 45.0,     # opposition
                "L_thumb_proximal_pitch_joint": 10.0,   # curl (flip sign if it opens)
                "L_thumb_intermediate_joint": 65.0,
                "L_thumb_distal_joint": 75.0,
            },
            "close_ramp_steps": 30,
    ...
    open_hand_after_second_goal = EventTerm(
        ...
        params={
            ...
            # open targets (degrees) – reuse your “open” pose
            "open_pos": {
                "L_index_proximal_joint": 0.0,
                "L_index_intermediate_joint": 0.0,
                "L_middle_proximal_joint": 0.0,
...
class CommandsCfg:
    ...
    ee_pose = mdp.UniformPoseCommandCfg(
        ...
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            ...
            roll=(1.5707963268, 1.5707963268),
            pitch=(-1.5707963268, -1.5707963268),
            yaw=(0.0, 0.0),
        ),
    )
...
class RewardsCfg:
    ...
    """ table_collision = RewTerm(
        ...
        params={
            "sensor_cfgs": [
                SceneEntityCfg("l_index_proximal_table_contact"),
                SceneEntityCfg("l_middle_proximal_table_contact"),
                SceneEntityCfg("l_pinky_proximal_table_contact"),
                SceneEntityCfg("l_ring_proximal_table_contact"),
                SceneEntityCfg("l_thumb_proximal_yaw_table_contact"),
                SceneEntityCfg("l_index_intermediate_table_contact"),
                SceneEntityCfg("l_middle_intermediate_table_contact"),
                SceneEntityCfg("l_pinky_intermediate_table_contact"),
                SceneEntityCfg("l_ring_intermediate_table_contact"),
                SceneEntityCfg("l_thumb_proximal_pitch_table_contact"),
                SceneEntityCfg("l_thumb_intermediate_table_contact"),
                SceneEntityCfg("l_thumb_distal_table_contact"),
            ],
            "min_force": 2.0,
            "max_force": 30.0,
        },
...
class G1ReachPoseEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: G1ReachPoseSceneCfg = G1ReachPoseSceneCfg(num_envs=256, env_spacing=2.5)
